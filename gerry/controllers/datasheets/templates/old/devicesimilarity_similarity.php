<table>
<tr>
<?php if(isset($similarity) && is_array($similarity)):?>
	<?php if($limit > 0):?>
		<td class="scrollbutton">
			<form class="ajax reload_tab" action="<?=FrontController::GetLink('devicesimilarity', 'changelimit')?>" method="POST">
				...
				<dl>
					...
					<dd>
						<div class="ratingstar">
							<div style="width:<?=$devices[$id][$id]['device_rating']?>%">
							</div>
						</div>
					</dd>
					<dt>
						<label for="similarity"><phrase id="SIMILARITY"/></label>
					</dt>
					<dd>
