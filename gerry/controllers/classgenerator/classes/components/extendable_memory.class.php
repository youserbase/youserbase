<?php
class extendable_memory
{

	protected static $instance = null;
	private static $table = 'extendable_memory';
	public static $data = array();
	public $extendable_memory_id;
	public $component_id;
	public $component_id_int;
	public $extendable_memory_type_id;
	public $extendable_memory_maxsize;
	...
	public function Get($extendable_memory_id = null)
	{
		if($extendable_memory_id != null)
		{
			self::$extendable_memory_id = $extendable_memory_id;
		}
	...
	{
		$description['extendable_memory_type_id'] = 'extendable_memory_type_id';
		$description['extendable_memory_maxsize'] = 'extendable_memory_maxsize';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM extendable_memory  LEFT JOIN extendable_memory_type ON extendable_memory.extendable_memory_type_id = extendable_memory_type.extendable_memory_type_id  LEFT JOIN memory_size_type ON extendable_memory.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN extendable_memory AS t ON extendable_memory.extendable_memory_id = t.extendable_memory_id WHERE extendable_memory.component_id = ? ORDER BY extendable_memory.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['extendable_memory_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['extendable_memory_type_id'] = 'select';
		$description['extendable_memory_maxsize'] = 'text';
		$description['memory_size_type_id'] = 'notshown';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM extendable_memory  LEFT JOIN extendable_memory_type ON extendable_memory.extendable_memory_type_id = extendable_memory_type.extendable_memory_type_id  LEFT JOIN memory_size_type ON extendable_memory.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN extendable_memory AS t ON extendable_memory.extendable_memory_id = t.extendable_memory_id WHERE extendable_memory.component_id = ? ORDER BY extendable_memory.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($extendable_memory_id = null, $component_id = null, $component_id_int = null, $extendable_memory_type_id = null, $extendable_memory_maxsize = null, $memory_size_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($extendable_memory_id !== null)
		{
			self::$extendable_memory_id = $extendable_memory_id;
		...
		}		if($extendable_memory_maxsize !== null)
		{
			self::$extendable_memory_maxsize = $extendable_memory_maxsize;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES extendable_memory WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO extendable_memory (extendable_memory_id, component_id, component_id_int, extendable_memory_type_id, extendable_memory_maxsize, memory_size_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE extendable_memory_id=VALUES(extendable_memory_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),extendable_memory_type_id=VALUES(extendable_memory_type_id),extendable_memory_maxsize=VALUES(extendable_memory_maxsize),memory_size_type_id=VALUES(memory_size_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->extendable_memory_id, $this->component_id, $this->component_id_int, $this->extendable_memory_type_id, $this->extendable_memory_maxsize, $this->memory_size_type_id, $this->timestamp, $this->youser_id);
