<?php
class email_protocoll
{

	protected static $instance = null;
	private static $table = 'email_protocoll';
	public static $data = array();
	public $email_protocoll_id;
	public $component_id;
	public $component_id_int;
	public $email_protocoll_type_id;
	public $email_protocoll_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($email_protocoll_id = null)
	{
		if($email_protocoll_id != null)
		{
			self::$email_protocoll_id = $email_protocoll_id;
		}
	...
	{
		$description['email_protocoll_type_id'] = 'email_protocoll_type_id';
		$description['email_protocoll_type_id_int'] = 'email_protocoll_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM email_protocoll  LEFT JOIN email_protocoll_type ON email_protocoll.email_protocoll_type_id = email_protocoll_type.email_protocoll_type_id  LEFT JOIN email_protocoll AS t ON email_protocoll.email_protocoll_id = t.email_protocoll_id WHERE email_protocoll.component_id = ? ORDER BY email_protocoll.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['email_protocoll_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['email_protocoll_type_id'] = 'multiple';
		$description['email_protocoll_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM email_protocoll  LEFT JOIN email_protocoll_type ON email_protocoll.email_protocoll_type_id = email_protocoll_type.email_protocoll_type_id  LEFT JOIN email_protocoll AS t ON email_protocoll.email_protocoll_id = t.email_protocoll_id WHERE email_protocoll.component_id = ? AND email_protocoll.timestamp = (SELECT MAX(timestamp) FROM email_protocoll WHERE email_protocoll.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($email_protocoll_id = null, $component_id = null, $component_id_int = null, $email_protocoll_type_id = null, $email_protocoll_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($email_protocoll_id !== null)
		{
			self::$email_protocoll_id = $email_protocoll_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES email_protocoll WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO email_protocoll (email_protocoll_id, component_id, component_id_int, email_protocoll_type_id, email_protocoll_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE email_protocoll_id=VALUES(email_protocoll_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),email_protocoll_type_id=VALUES(email_protocoll_type_id),email_protocoll_type_id_int=VALUES(email_protocoll_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->email_protocoll_id, $this->component_id, $this->component_id_int, $this->email_protocoll_type_id, $this->email_protocoll_type_id_int, $this->timestamp, $this->youser_id);
