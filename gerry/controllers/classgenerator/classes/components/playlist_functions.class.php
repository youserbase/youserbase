<?php
class playlist_functions
{

	protected static $instance = null;
	private static $table = 'playlist_functions';
	public static $data = array();
	public $playlist_functions_id;
	public $component_id;
	public $component_id_int;
	public $playlist_functions_type_id;
	public $playlist_functions_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($playlist_functions_id = null)
	{
		if($playlist_functions_id != null)
		{
			self::$playlist_functions_id = $playlist_functions_id;
		}
	...
	{
		$description['playlist_functions_type_id'] = 'playlist_functions_type_id';
		$description['playlist_functions_type_id_int'] = 'playlist_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM playlist_functions  LEFT JOIN playlist_functions_type ON playlist_functions.playlist_functions_type_id = playlist_functions_type.playlist_functions_type_id  LEFT JOIN playlist_functions AS t ON playlist_functions.playlist_functions_id = t.playlist_functions_id WHERE playlist_functions.component_id = ? ORDER BY playlist_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['playlist_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['playlist_functions_type_id'] = 'multiple';
		$description['playlist_functions_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM playlist_functions  LEFT JOIN playlist_functions_type ON playlist_functions.playlist_functions_type_id = playlist_functions_type.playlist_functions_type_id  LEFT JOIN playlist_functions AS t ON playlist_functions.playlist_functions_id = t.playlist_functions_id WHERE playlist_functions.component_id = ? AND playlist_functions.timestamp = (SELECT MAX(timestamp) FROM playlist_functions WHERE playlist_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($playlist_functions_id = null, $component_id = null, $component_id_int = null, $playlist_functions_type_id = null, $playlist_functions_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($playlist_functions_id !== null)
		{
			self::$playlist_functions_id = $playlist_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES playlist_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO playlist_functions (playlist_functions_id, component_id, component_id_int, playlist_functions_type_id, playlist_functions_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE playlist_functions_id=VALUES(playlist_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),playlist_functions_type_id=VALUES(playlist_functions_type_id),playlist_functions_type_id_int=VALUES(playlist_functions_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->playlist_functions_id, $this->component_id, $this->component_id_int, $this->playlist_functions_type_id, $this->playlist_functions_type_id_int, $this->timestamp, $this->youser_id);
