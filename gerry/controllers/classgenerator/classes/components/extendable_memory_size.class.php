<?php
class extendable_memory_size
{

	protected static $instance = null;
	private static $table = 'extendable_memory_size';
	public static $data = array();
	public $extendable_memory_size_id;
	public $component_id;
	...
	public function Get($extendable_memory_size_id = null)
	{
		if($extendable_memory_size_id != null)
		{
			self::$extendable_memory_size_id = $extendable_memory_size_id;
		}
	...
	{
		$description['component_id'] = 'component_id';
		$description['component_id_int'] = 'component_id_int';
		$description['extendable_memory_maxsize'] = 'extendable_memory_maxsize';
		$description['memory_size_type_id'] = 'memory_size_type_id';
		$description['youser_id'] = 'youser_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM extendable_memory_size  LEFT JOIN memory_size_type ON extendable_memory_size.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN extendable_memory_size AS t ON extendable_memory_size.extendable_memory_size_id = t.extendable_memory_size_id WHERE extendable_memory_size.component_id = ? ORDER BY extendable_memory_size.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['extendable_memory_size_id'] = 'hidden';
		$description['component_id'] = '';
		$description['component_id_int'] = '';
		$description['extendable_memory_maxsize'] = 'text';
		$description['memory_size_type_id'] = '';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = '';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM extendable_memory_size  LEFT JOIN memory_size_type ON extendable_memory_size.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN extendable_memory_size AS t ON extendable_memory_size.extendable_memory_size_id = t.extendable_memory_size_id WHERE extendable_memory_size.component_id = ? ORDER BY extendable_memory_size.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($extendable_memory_size_id = null, $component_id = null, $component_id_int = null, $extendable_memory_maxsize = null, $memory_size_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($extendable_memory_size_id !== null)
		{
			self::$extendable_memory_size_id = $extendable_memory_size_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES extendable_memory_size WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO extendable_memory_size (extendable_memory_size_id, component_id, component_id_int, extendable_memory_maxsize, memory_size_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE extendable_memory_size_id=VALUES(extendable_memory_size_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),extendable_memory_maxsize=VALUES(extendable_memory_maxsize),memory_size_type_id=VALUES(memory_size_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->extendable_memory_size_id, $this->component_id, $this->component_id_int, $this->extendable_memory_maxsize, $this->memory_size_type_id, $this->timestamp, $this->youser_id);
