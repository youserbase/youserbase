<?php
class ringtone_format
{

	protected static $instance = null;
	private static $table = 'ringtone_format';
	public static $data = array();
	public $ringtone_format_id;
	public $component_id;
	public $component_id_int;
	public $ringtone_format_type_id;
	public $ringtone_format_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($ringtone_format_id = null)
	{
		if($ringtone_format_id != null)
		{
			self::$ringtone_format_id = $ringtone_format_id;
		}
	...
	{
		$description['ringtone_format_type_id'] = 'ringtone_format_type_id';
		$description['ringtone_format_type_id_int'] = 'ringtone_format_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM ringtone_format  LEFT JOIN ringtone_format_type ON ringtone_format.ringtone_format_type_id = ringtone_format_type.ringtone_format_type_id  LEFT JOIN ringtone_format AS t ON ringtone_format.ringtone_format_id = t.ringtone_format_id WHERE ringtone_format.component_id = ? ORDER BY ringtone_format.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['ringtone_format_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['ringtone_format_type_id'] = 'multiple';
		$description['ringtone_format_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM ringtone_format  LEFT JOIN ringtone_format_type ON ringtone_format.ringtone_format_type_id = ringtone_format_type.ringtone_format_type_id  LEFT JOIN ringtone_format AS t ON ringtone_format.ringtone_format_id = t.ringtone_format_id WHERE ringtone_format.component_id = ? AND ringtone_format.timestamp = (SELECT MAX(timestamp) FROM ringtone_format WHERE ringtone_format.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($ringtone_format_id = null, $component_id = null, $component_id_int = null, $ringtone_format_type_id = null, $ringtone_format_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($ringtone_format_id !== null)
		{
			self::$ringtone_format_id = $ringtone_format_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES ringtone_format WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO ringtone_format (ringtone_format_id, component_id, component_id_int, ringtone_format_type_id, ringtone_format_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE ringtone_format_id=VALUES(ringtone_format_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),ringtone_format_type_id=VALUES(ringtone_format_type_id),ringtone_format_type_id_int=VALUES(ringtone_format_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->ringtone_format_id, $this->component_id, $this->component_id_int, $this->ringtone_format_type_id, $this->ringtone_format_type_id_int, $this->timestamp, $this->youser_id);
