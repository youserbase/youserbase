...
class email_functions
{
	...
	private static $table = 'email_functions';
	public static $data = array();
	public $email_functions_id;
	public $component_id;
	public $component_id_int;
	public $email_functions_type_id;
	public $email_functions_type_id_int;
	public $youser_id;
	public $timestamp;
	...
	public function Get($email_functions_id = null)
	{
		if($email_functions_id != null)
		{
			self::$email_functions_id = $email_functions_id;
		}
	...
	{
		$description['email_functions_type_id'] = 'email_functions_type_id';
		$description['email_functions_type_id_int'] = 'email_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM email_functions  LEFT JOIN email_functions_type ON email_functions.email_functions_type_id = email_functions_type.email_functions_type_id  LEFT JOIN email_functions AS t ON email_functions.email_functions_id = t.email_functions_id WHERE email_functions.component_id = ? ORDER BY email_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['email_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['email_functions_type_id'] = 'multiple';
		$description['email_functions_type_id_int'] = 'multiple';
		$description['youser_id'] = 'notshown';
		$description['timestamp'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM email_functions  LEFT JOIN email_functions_type ON email_functions.email_functions_type_id = email_functions_type.email_functions_type_id  LEFT JOIN email_functions AS t ON email_functions.email_functions_id = t.email_functions_id WHERE email_functions.component_id = ? AND email_functions.timestamp = (SELECT MAX(timestamp) FROM email_functions WHERE email_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($email_functions_id = null, $component_id = null, $component_id_int = null, $email_functions_type_id = null, $email_functions_type_id_int = null, $youser_id = null, $timestamp = null)
	{
		if($email_functions_id !== null)
		{
			self::$email_functions_id = $email_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES email_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO email_functions (email_functions_id, component_id, component_id_int, email_functions_type_id, email_functions_type_id_int, youser_id, timestamp) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE email_functions_id=VALUES(email_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),email_functions_type_id=VALUES(email_functions_type_id),email_functions_type_id_int=VALUES(email_functions_type_id_int),youser_id=VALUES(youser_id),timestamp=VALUES(timestamp);", $this->email_functions_id, $this->component_id, $this->component_id_int, $this->email_functions_type_id, $this->email_functions_type_id_int, $this->youser_id, $this->timestamp);
