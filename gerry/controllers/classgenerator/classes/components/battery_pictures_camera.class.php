<?php
class battery_pictures_camera
{

	protected static $instance = null;
	private static $table = 'battery_pictures_camera';
	public static $data = array();
	public $battery_pictures_camera_id;
	public $component_id;
	public $component_id_int;
	public $battery_pictures_camera_without_flash;
	public $battery_pictures_camera_with_flash;
	public $timestamp;
	public $youser_id;
	...
	public function Get($battery_pictures_camera_id = null)
	{
		if($battery_pictures_camera_id != null)
		{
			self::$battery_pictures_camera_id = $battery_pictures_camera_id;
		}
	...
	{
		$description['battery_pictures_camera_without_flash'] = 'battery_pictures_camera_without_flash';
		$description['battery_pictures_camera_with_flash'] = 'battery_pictures_camera_with_flash';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM battery_pictures_camera  WHERE battery_pictures_camera.component_id = ? ORDER BY battery_pictures_camera.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['battery_pictures_camera_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['battery_pictures_camera_without_flash'] = 'text';
		$description['battery_pictures_camera_with_flash'] = 'text';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM battery_pictures_camera  WHERE battery_pictures_camera.component_id = ? ORDER BY battery_pictures_camera.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($battery_pictures_camera_id = null, $component_id = null, $component_id_int = null, $battery_pictures_camera_without_flash = null, $battery_pictures_camera_with_flash = null, $timestamp = null, $youser_id = null)
	{
		if($battery_pictures_camera_id !== null)
		{
			self::$battery_pictures_camera_id = $battery_pictures_camera_id;
		...
		}		if($battery_pictures_camera_without_flash !== null)
		{
			self::$battery_pictures_camera_without_flash = $battery_pictures_camera_without_flash;
		}		if($battery_pictures_camera_with_flash !== null)
		{
			self::$battery_pictures_camera_with_flash = $battery_pictures_camera_with_flash;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES battery_pictures_camera WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO battery_pictures_camera (battery_pictures_camera_id, component_id, component_id_int, battery_pictures_camera_without_flash, battery_pictures_camera_with_flash, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE battery_pictures_camera_id=VALUES(battery_pictures_camera_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),battery_pictures_camera_without_flash=VALUES(battery_pictures_camera_without_flash),battery_pictures_camera_with_flash=VALUES(battery_pictures_camera_with_flash),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->battery_pictures_camera_id, $this->component_id, $this->component_id_int, $this->battery_pictures_camera_without_flash, $this->battery_pictures_camera_with_flash, $this->timestamp, $this->youser_id);
