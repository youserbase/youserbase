<?php
class video_play_format
{

	protected static $instance = null;
	private static $table = 'video_play_format';
	public static $data = array();
	public $video_play_format_id;
	public $component_id;
	public $component_id_int;
	public $video_format_type_id;
	public $video_format_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($video_play_format_id = null)
	{
		if($video_play_format_id != null)
		{
			self::$video_play_format_id = $video_play_format_id;
		}
	...
	{
		$description['video_format_type_id'] = 'video_format_type_id';
		$description['video_format_type_id_int'] = 'video_format_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM video_play_format  LEFT JOIN video_format_type ON video_play_format.video_format_type_id = video_format_type.video_format_type_id  LEFT JOIN video_play_format AS t ON video_play_format.video_play_format_id = t.video_play_format_id WHERE video_play_format.component_id = ? ORDER BY video_play_format.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['video_play_format_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['video_format_type_id'] = 'multiple';
		$description['video_format_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM video_play_format  LEFT JOIN video_format_type ON video_play_format.video_format_type_id = video_format_type.video_format_type_id  LEFT JOIN video_play_format AS t ON video_play_format.video_play_format_id = t.video_play_format_id WHERE video_play_format.component_id = ? AND video_play_format.timestamp = (SELECT MAX(timestamp) FROM video_play_format WHERE video_play_format.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($video_play_format_id = null, $component_id = null, $component_id_int = null, $video_format_type_id = null, $video_format_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($video_play_format_id !== null)
		{
			self::$video_play_format_id = $video_play_format_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES video_play_format WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO video_play_format (video_play_format_id, component_id, component_id_int, video_format_type_id, video_format_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE video_play_format_id=VALUES(video_play_format_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),video_format_type_id=VALUES(video_format_type_id),video_format_type_id_int=VALUES(video_format_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->video_play_format_id, $this->component_id, $this->component_id_int, $this->video_format_type_id, $this->video_format_type_id_int, $this->timestamp, $this->youser_id);
