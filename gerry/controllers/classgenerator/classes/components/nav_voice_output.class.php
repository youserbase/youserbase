<?php
class nav_voice_output
{

	protected static $instance = null;
	private static $table = 'nav_voice_output';
	public static $data = array();
	public $nav_voice_output_id;
	public $component_id;
	public $component_id_int;
	public $nav_voice_output_type_id;
	public $timestamp;
	public $youser_id;
	...
	public function Get($nav_voice_output_id = null)
	{
		if($nav_voice_output_id != null)
		{
			self::$nav_voice_output_id = $nav_voice_output_id;
		}
	...
	{
		$description['nav_voice_output_type_id'] = 'nav_voice_output_type_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM nav_voice_output  LEFT JOIN nav_voice_output_type ON nav_voice_output.nav_voice_output_type_id = nav_voice_output_type.nav_voice_output_type_id  LEFT JOIN nav_voice_output AS t ON nav_voice_output.nav_voice_output_id = t.nav_voice_output_id WHERE nav_voice_output.component_id = ? ORDER BY nav_voice_output.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['nav_voice_output_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['nav_voice_output_type_id'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM nav_voice_output  LEFT JOIN nav_voice_output_type ON nav_voice_output.nav_voice_output_type_id = nav_voice_output_type.nav_voice_output_type_id  LEFT JOIN nav_voice_output AS t ON nav_voice_output.nav_voice_output_id = t.nav_voice_output_id WHERE nav_voice_output.component_id = ? AND nav_voice_output.timestamp = (SELECT MAX(timestamp) FROM nav_voice_output WHERE nav_voice_output.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($nav_voice_output_id = null, $component_id = null, $component_id_int = null, $nav_voice_output_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($nav_voice_output_id !== null)
		{
			self::$nav_voice_output_id = $nav_voice_output_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES nav_voice_output WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO nav_voice_output (nav_voice_output_id, component_id, component_id_int, nav_voice_output_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE nav_voice_output_id=VALUES(nav_voice_output_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),nav_voice_output_type_id=VALUES(nav_voice_output_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->nav_voice_output_id, $this->component_id, $this->component_id_int, $this->nav_voice_output_type_id, $this->timestamp, $this->youser_id);
