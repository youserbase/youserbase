...
class background_picture
{
	...
	private static $table = 'background_picture';
	public static $data = array();
	public $background_picture_id;
	public $component_id;
	public $component_id_int;
	public $background_picture_type_id;
	public $background_picture_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($background_picture_id = null)
	{
		if($background_picture_id != null)
		{
	...
	{
		$description['background_picture_type_id'] = 'background_picture_type_id';
		$description['background_picture_type_id_int'] = 'background_picture_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM background_picture  LEFT JOIN background_picture_type ON background_picture.background_picture_type_id = background_picture_type.background_picture_type_id  LEFT JOIN background_picture AS t ON background_picture.background_picture_id = t.background_picture_id WHERE background_picture.component_id = ? ORDER BY background_picture.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['background_picture_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['background_picture_type_id'] = 'multiple';
		$description['background_picture_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM background_picture  LEFT JOIN background_picture_type ON background_picture.background_picture_type_id = background_picture_type.background_picture_type_id  LEFT JOIN background_picture AS t ON background_picture.background_picture_id = t.background_picture_id WHERE background_picture.component_id = ? AND background_picture.timestamp = (SELECT MAX(timestamp) FROM background_picture WHERE background_picture.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($background_picture_id = null, $component_id = null, $component_id_int = null, $background_picture_type_id = null, $background_picture_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($background_picture_id !== null)
		{
			self::$background_picture_id = $background_picture_id;
		...
		}		if($background_picture_type_id !== null)
		{
			self::$background_picture_type_id = $background_picture_type_id;
		}		if($background_picture_type_id_int !== null)
		{
			self::$background_picture_type_id_int = $background_picture_type_id_int;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES background_picture WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO background_picture (background_picture_id, component_id, component_id_int, background_picture_type_id, background_picture_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE background_picture_id=VALUES(background_picture_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),background_picture_type_id=VALUES(background_picture_type_id),background_picture_type_id_int=VALUES(background_picture_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->background_picture_id, $this->component_id, $this->component_id_int, $this->background_picture_type_id, $this->background_picture_type_id_int, $this->timestamp, $this->youser_id);
