<?php
class modem_wireless_connections
{

	protected static $instance = null;
	private static $table = 'modem_wireless_connections';
	public static $data = array();
	public $modem_wireless_connections_id;
	public $component_id;
	public $component_id_int;
	public $data_network_type_id;
	public $data_network_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($modem_wireless_connections_id = null)
	{
		if($modem_wireless_connections_id != null)
		{
			self::$modem_wireless_connections_id = $modem_wireless_connections_id;
		}
	...
	{
		$description['data_network_type_id'] = 'data_network_type_id';
		$description['data_network_type_id_int'] = 'data_network_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM modem_wireless_connections  LEFT JOIN data_network_type ON modem_wireless_connections.data_network_type_id = data_network_type.data_network_type_id  LEFT JOIN modem_wireless_connections AS t ON modem_wireless_connections.modem_wireless_connections_id = t.modem_wireless_connections_id WHERE modem_wireless_connections.component_id = ? ORDER BY modem_wireless_connections.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['modem_wireless_connections_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['data_network_type_id'] = 'multiple';
		$description['data_network_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM modem_wireless_connections  LEFT JOIN data_network_type ON modem_wireless_connections.data_network_type_id = data_network_type.data_network_type_id  LEFT JOIN modem_wireless_connections AS t ON modem_wireless_connections.modem_wireless_connections_id = t.modem_wireless_connections_id WHERE modem_wireless_connections.component_id = ? AND modem_wireless_connections.timestamp = (SELECT MAX(timestamp) FROM modem_wireless_connections WHERE modem_wireless_connections.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($modem_wireless_connections_id = null, $component_id = null, $component_id_int = null, $data_network_type_id = null, $data_network_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($modem_wireless_connections_id !== null)
		{
			self::$modem_wireless_connections_id = $modem_wireless_connections_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES modem_wireless_connections WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO modem_wireless_connections (modem_wireless_connections_id, component_id, component_id_int, data_network_type_id, data_network_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE modem_wireless_connections_id=VALUES(modem_wireless_connections_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),data_network_type_id=VALUES(data_network_type_id),data_network_type_id_int=VALUES(data_network_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->modem_wireless_connections_id, $this->component_id, $this->component_id_int, $this->data_network_type_id, $this->data_network_type_id_int, $this->timestamp, $this->youser_id);
