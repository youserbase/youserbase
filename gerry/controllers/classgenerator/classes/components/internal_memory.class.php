...
class internal_memory
{
	...
	private static $table = 'internal_memory';
	public static $data = array();
	public $internal_memory_id;
	public $component_id;
	public $component_id_int;
	public $internal_memory_type_id;
	public $internal_memory_size;
	...
	public function Get($internal_memory_id = null)
	{
		if($internal_memory_id != null)
		{
			self::$internal_memory_id = $internal_memory_id;
		}
	...
	{
		$description['internal_memory_type_id'] = 'internal_memory_type_id';
		$description['internal_memory_size'] = 'internal_memory_size';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM internal_memory  LEFT JOIN internal_memory_type ON internal_memory.internal_memory_type_id = internal_memory_type.internal_memory_type_id  LEFT JOIN memory_size_type ON internal_memory.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN internal_memory AS t ON internal_memory.internal_memory_id = t.internal_memory_id WHERE internal_memory.component_id = ? ORDER BY internal_memory.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['internal_memory_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['internal_memory_type_id'] = 'select';
		$description['internal_memory_size'] = 'text';
		$description['memory_size_type_id'] = 'notshown';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM internal_memory  LEFT JOIN internal_memory_type ON internal_memory.internal_memory_type_id = internal_memory_type.internal_memory_type_id  LEFT JOIN memory_size_type ON internal_memory.memory_size_type_id = memory_size_type.memory_size_type_id  LEFT JOIN internal_memory AS t ON internal_memory.internal_memory_id = t.internal_memory_id WHERE internal_memory.component_id = ? ORDER BY internal_memory.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($internal_memory_id = null, $component_id = null, $component_id_int = null, $internal_memory_type_id = null, $internal_memory_size = null, $memory_size_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($internal_memory_id !== null)
		{
			self::$internal_memory_id = $internal_memory_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES internal_memory WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO internal_memory (internal_memory_id, component_id, component_id_int, internal_memory_type_id, internal_memory_size, memory_size_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE internal_memory_id=VALUES(internal_memory_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),internal_memory_type_id=VALUES(internal_memory_type_id),internal_memory_size=VALUES(internal_memory_size),memory_size_type_id=VALUES(memory_size_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->internal_memory_id, $this->component_id, $this->component_id_int, $this->internal_memory_type_id, $this->internal_memory_size, $this->memory_size_type_id, $this->timestamp, $this->youser_id);
