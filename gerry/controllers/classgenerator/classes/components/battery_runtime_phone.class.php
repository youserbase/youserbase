<?php
class battery_runtime_phone
{

	protected static $instance = null;
	private static $table = 'battery_runtime_phone';
	public static $data = array();
	public $battery_runtime_phone_id;
	public $component_id;
	public $component_id_int;
	public $battery_runtime_phone_umts;
	public $battery_runtime_phone_gsm;
	...
	public function Get($battery_runtime_phone_id = null)
	{
		if($battery_runtime_phone_id != null)
		{
			self::$battery_runtime_phone_id = $battery_runtime_phone_id;
		}
	...
	{
		$description['battery_runtime_phone_umts'] = 'battery_runtime_phone_umts';
		$description['battery_runtime_phone_gsm'] = 'battery_runtime_phone_gsm';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM battery_runtime_phone  LEFT JOIN time_units_type ON battery_runtime_phone.time_units_type_id = time_units_type.time_units_type_id  LEFT JOIN battery_runtime_phone AS t ON battery_runtime_phone.battery_runtime_phone_id = t.battery_runtime_phone_id WHERE battery_runtime_phone.component_id = ? ORDER BY battery_runtime_phone.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['battery_runtime_phone_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['battery_runtime_phone_umts'] = 'text';
		$description['battery_runtime_phone_gsm'] = 'text';
		$description['time_units_type_id'] = 'notshown';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM battery_runtime_phone  LEFT JOIN time_units_type ON battery_runtime_phone.time_units_type_id = time_units_type.time_units_type_id  LEFT JOIN battery_runtime_phone AS t ON battery_runtime_phone.battery_runtime_phone_id = t.battery_runtime_phone_id WHERE battery_runtime_phone.component_id = ? ORDER BY battery_runtime_phone.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($battery_runtime_phone_id = null, $component_id = null, $component_id_int = null, $battery_runtime_phone_umts = null, $battery_runtime_phone_gsm = null, $time_units_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($battery_runtime_phone_id !== null)
		{
			self::$battery_runtime_phone_id = $battery_runtime_phone_id;
		...
		}		if($battery_runtime_phone_umts !== null)
		{
			self::$battery_runtime_phone_umts = $battery_runtime_phone_umts;
		}		if($battery_runtime_phone_gsm !== null)
		{
			self::$battery_runtime_phone_gsm = $battery_runtime_phone_gsm;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES battery_runtime_phone WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO battery_runtime_phone (battery_runtime_phone_id, component_id, component_id_int, battery_runtime_phone_umts, battery_runtime_phone_gsm, time_units_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE battery_runtime_phone_id=VALUES(battery_runtime_phone_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),battery_runtime_phone_umts=VALUES(battery_runtime_phone_umts),battery_runtime_phone_gsm=VALUES(battery_runtime_phone_gsm),time_units_type_id=VALUES(time_units_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->battery_runtime_phone_id, $this->component_id, $this->component_id_int, $this->battery_runtime_phone_umts, $this->battery_runtime_phone_gsm, $this->time_units_type_id, $this->timestamp, $this->youser_id);
