...
class mms_data
{
	...
	private static $table = 'mms_data';
	public static $data = array();
	public $mms_data_id;
	public $component_id;
	public $component_id_int;
	public $mms_data_type_id;
	public $mms_data_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($mms_data_id = null)
	{
		if($mms_data_id != null)
		{
			self::$mms_data_id = $mms_data_id;
		}
	...
	{
		$description['mms_data_type_id'] = 'mms_data_type_id';
		$description['mms_data_type_id_int'] = 'mms_data_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM mms_data  LEFT JOIN mms_data_type ON mms_data.mms_data_type_id = mms_data_type.mms_data_type_id  LEFT JOIN mms_data AS t ON mms_data.mms_data_id = t.mms_data_id WHERE mms_data.component_id = ? ORDER BY mms_data.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['mms_data_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['mms_data_type_id'] = 'multiple';
		$description['mms_data_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM mms_data  LEFT JOIN mms_data_type ON mms_data.mms_data_type_id = mms_data_type.mms_data_type_id  LEFT JOIN mms_data AS t ON mms_data.mms_data_id = t.mms_data_id WHERE mms_data.component_id = ? AND mms_data.timestamp = (SELECT MAX(timestamp) FROM mms_data WHERE mms_data.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($mms_data_id = null, $component_id = null, $component_id_int = null, $mms_data_type_id = null, $mms_data_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($mms_data_id !== null)
		{
			self::$mms_data_id = $mms_data_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES mms_data WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO mms_data (mms_data_id, component_id, component_id_int, mms_data_type_id, mms_data_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE mms_data_id=VALUES(mms_data_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),mms_data_type_id=VALUES(mms_data_type_id),mms_data_type_id_int=VALUES(mms_data_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->mms_data_id, $this->component_id, $this->component_id_int, $this->mms_data_type_id, $this->mms_data_type_id_int, $this->timestamp, $this->youser_id);
