<?php
class instant_messenger
{

	protected static $instance = null;
	private static $table = 'instant_messenger';
	public static $data = array();
	public $instant_messenger_id;
	public $component_id;
	public $component_id_int;
	public $instant_messenger_type_id;
	public $instant_messenger_type_id_int;
	public $youser_id;
	public $timestamp;
	...
	public function Get($instant_messenger_id = null)
	{
		if($instant_messenger_id != null)
		{
			self::$instant_messenger_id = $instant_messenger_id;
		}
	...
	{
		$description['instant_messenger_type_id'] = 'instant_messenger_type_id';
		$description['instant_messenger_type_id_int'] = 'instant_messenger_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM instant_messenger  LEFT JOIN instant_messenger_type ON instant_messenger.instant_messenger_type_id = instant_messenger_type.instant_messenger_type_id  LEFT JOIN instant_messenger AS t ON instant_messenger.instant_messenger_id = t.instant_messenger_id WHERE instant_messenger.component_id = ? ORDER BY instant_messenger.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['instant_messenger_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['instant_messenger_type_id'] = 'multiple';
		$description['instant_messenger_type_id_int'] = 'multiple';
		$description['youser_id'] = 'notshown';
		$description['timestamp'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM instant_messenger  LEFT JOIN instant_messenger_type ON instant_messenger.instant_messenger_type_id = instant_messenger_type.instant_messenger_type_id  LEFT JOIN instant_messenger AS t ON instant_messenger.instant_messenger_id = t.instant_messenger_id WHERE instant_messenger.component_id = ? AND instant_messenger.timestamp = (SELECT MAX(timestamp) FROM instant_messenger WHERE instant_messenger.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($instant_messenger_id = null, $component_id = null, $component_id_int = null, $instant_messenger_type_id = null, $instant_messenger_type_id_int = null, $youser_id = null, $timestamp = null)
	{
		if($instant_messenger_id !== null)
		{
			self::$instant_messenger_id = $instant_messenger_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES instant_messenger WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO instant_messenger (instant_messenger_id, component_id, component_id_int, instant_messenger_type_id, instant_messenger_type_id_int, youser_id, timestamp) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE instant_messenger_id=VALUES(instant_messenger_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),instant_messenger_type_id=VALUES(instant_messenger_type_id),instant_messenger_type_id_int=VALUES(instant_messenger_type_id_int),youser_id=VALUES(youser_id),timestamp=VALUES(timestamp);", $this->instant_messenger_id, $this->component_id, $this->component_id_int, $this->instant_messenger_type_id, $this->instant_messenger_type_id_int, $this->youser_id, $this->timestamp);
