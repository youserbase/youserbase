<?php
class calendars_functions
{

	protected static $instance = null;
	private static $table = 'calendars_functions';
	public static $data = array();
	public $calendars_functions_id;
	public $component_id;
	public $component_id_int;
	public $calendars_functions_type_id;
	public $calendars_functions_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($calendars_functions_id = null)
	{
		if($calendars_functions_id != null)
		{
			self::$calendars_functions_id = $calendars_functions_id;
		}
	...
	{
		$description['calendars_functions_type_id'] = 'calendars_functions_type_id';
		$description['calendars_functions_type_id_int'] = 'calendars_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM calendars_functions  LEFT JOIN calendars_functions_type ON calendars_functions.calendars_functions_type_id = calendars_functions_type.calendars_functions_type_id  LEFT JOIN calendars_functions AS t ON calendars_functions.calendars_functions_id = t.calendars_functions_id WHERE calendars_functions.component_id = ? ORDER BY calendars_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['calendars_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['calendars_functions_type_id'] = 'multiple';
		$description['calendars_functions_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM calendars_functions  LEFT JOIN calendars_functions_type ON calendars_functions.calendars_functions_type_id = calendars_functions_type.calendars_functions_type_id  LEFT JOIN calendars_functions AS t ON calendars_functions.calendars_functions_id = t.calendars_functions_id WHERE calendars_functions.component_id = ? AND calendars_functions.timestamp = (SELECT MAX(timestamp) FROM calendars_functions WHERE calendars_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($calendars_functions_id = null, $component_id = null, $component_id_int = null, $calendars_functions_type_id = null, $calendars_functions_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($calendars_functions_id !== null)
		{
			self::$calendars_functions_id = $calendars_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES calendars_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO calendars_functions (calendars_functions_id, component_id, component_id_int, calendars_functions_type_id, calendars_functions_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE calendars_functions_id=VALUES(calendars_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),calendars_functions_type_id=VALUES(calendars_functions_type_id),calendars_functions_type_id_int=VALUES(calendars_functions_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->calendars_functions_id, $this->component_id, $this->component_id_int, $this->calendars_functions_type_id, $this->calendars_functions_type_id_int, $this->timestamp, $this->youser_id);
