<?php
class camera_programs
{

	protected static $instance = null;
	private static $table = 'camera_programs';
	public static $data = array();
	public $camera_programs_id;
	public $component_id;
	public $component_id_int;
	public $camera_programs_type_id;
	public $camera_programs_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($camera_programs_id = null)
	{
		if($camera_programs_id != null)
		{
			self::$camera_programs_id = $camera_programs_id;
		}
	...
	{
		$description['camera_programs_type_id'] = 'camera_programs_type_id';
		$description['camera_programs_type_id_int'] = 'camera_programs_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM camera_programs  LEFT JOIN camera_programs_type ON camera_programs.camera_programs_type_id = camera_programs_type.camera_programs_type_id  LEFT JOIN camera_programs AS t ON camera_programs.camera_programs_id = t.camera_programs_id WHERE camera_programs.component_id = ? ORDER BY camera_programs.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['camera_programs_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['camera_programs_type_id'] = 'multiple';
		$description['camera_programs_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM camera_programs  LEFT JOIN camera_programs_type ON camera_programs.camera_programs_type_id = camera_programs_type.camera_programs_type_id  LEFT JOIN camera_programs AS t ON camera_programs.camera_programs_id = t.camera_programs_id WHERE camera_programs.component_id = ? AND camera_programs.timestamp = (SELECT MAX(timestamp) FROM camera_programs WHERE camera_programs.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($camera_programs_id = null, $component_id = null, $component_id_int = null, $camera_programs_type_id = null, $camera_programs_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($camera_programs_id !== null)
		{
			self::$camera_programs_id = $camera_programs_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES camera_programs WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO camera_programs (camera_programs_id, component_id, component_id_int, camera_programs_type_id, camera_programs_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE camera_programs_id=VALUES(camera_programs_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),camera_programs_type_id=VALUES(camera_programs_type_id),camera_programs_type_id_int=VALUES(camera_programs_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->camera_programs_id, $this->component_id, $this->component_id_int, $this->camera_programs_type_id, $this->camera_programs_type_id_int, $this->timestamp, $this->youser_id);
