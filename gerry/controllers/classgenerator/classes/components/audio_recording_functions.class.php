<?php
class audio_recording_functions
{

	protected static $instance = null;
	private static $table = 'audio_recording_functions';
	public static $data = array();
	public $audio_recording_functions_id;
	public $component_id;
	public $component_id_int;
	public $audio_recording_functions_type_id;
	public $audio_recording_functions_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($audio_recording_functions_id = null)
	{
		if($audio_recording_functions_id != null)
		{
			self::$audio_recording_functions_id = $audio_recording_functions_id;
		}
	...
	{
		$description['audio_recording_functions_type_id'] = 'audio_recording_functions_type_id';
		$description['audio_recording_functions_type_id_int'] = 'audio_recording_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM audio_recording_functions  LEFT JOIN audio_recording_functions_type ON audio_recording_functions.audio_recording_functions_type_id = audio_recording_functions_type.audio_recording_functions_type_id  LEFT JOIN audio_recording_functions AS t ON audio_recording_functions.audio_recording_functions_id = t.audio_recording_functions_id WHERE audio_recording_functions.component_id = ? ORDER BY audio_recording_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['audio_recording_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['audio_recording_functions_type_id'] = 'multiple';
		$description['audio_recording_functions_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM audio_recording_functions  LEFT JOIN audio_recording_functions_type ON audio_recording_functions.audio_recording_functions_type_id = audio_recording_functions_type.audio_recording_functions_type_id  LEFT JOIN audio_recording_functions AS t ON audio_recording_functions.audio_recording_functions_id = t.audio_recording_functions_id WHERE audio_recording_functions.component_id = ? AND audio_recording_functions.timestamp = (SELECT MAX(timestamp) FROM audio_recording_functions WHERE audio_recording_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($audio_recording_functions_id = null, $component_id = null, $component_id_int = null, $audio_recording_functions_type_id = null, $audio_recording_functions_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($audio_recording_functions_id !== null)
		{
			self::$audio_recording_functions_id = $audio_recording_functions_id;
		...
		}		if($audio_recording_functions_type_id !== null)
		{
			self::$audio_recording_functions_type_id = $audio_recording_functions_type_id;
		}		if($audio_recording_functions_type_id_int !== null)
		{
			self::$audio_recording_functions_type_id_int = $audio_recording_functions_type_id_int;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES audio_recording_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO audio_recording_functions (audio_recording_functions_id, component_id, component_id_int, audio_recording_functions_type_id, audio_recording_functions_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE audio_recording_functions_id=VALUES(audio_recording_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),audio_recording_functions_type_id=VALUES(audio_recording_functions_type_id),audio_recording_functions_type_id_int=VALUES(audio_recording_functions_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->audio_recording_functions_id, $this->component_id, $this->component_id_int, $this->audio_recording_functions_type_id, $this->audio_recording_functions_type_id_int, $this->timestamp, $this->youser_id);
