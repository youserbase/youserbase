<?php
class image_stabilizer
{

	protected static $instance = null;
	private static $table = 'image_stabilizer';
	public static $data = array();
	public $image_stabilizer_id;
	public $component_id;
	public $component_id_int;
	public $image_stabilizer_type_id;
	public $image_stabilizer_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($image_stabilizer_id = null)
	{
		if($image_stabilizer_id != null)
		{
			self::$image_stabilizer_id = $image_stabilizer_id;
		}
	...
	{
		$description['image_stabilizer_type_id'] = 'image_stabilizer_type_id';
		$description['image_stabilizer_type_id_int'] = 'image_stabilizer_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM image_stabilizer  LEFT JOIN image_stabilizer_type ON image_stabilizer.image_stabilizer_type_id = image_stabilizer_type.image_stabilizer_type_id  LEFT JOIN image_stabilizer AS t ON image_stabilizer.image_stabilizer_id = t.image_stabilizer_id WHERE image_stabilizer.component_id = ? ORDER BY image_stabilizer.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['image_stabilizer_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['image_stabilizer_type_id'] = 'multiple';
		$description['image_stabilizer_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM image_stabilizer  LEFT JOIN image_stabilizer_type ON image_stabilizer.image_stabilizer_type_id = image_stabilizer_type.image_stabilizer_type_id  LEFT JOIN image_stabilizer AS t ON image_stabilizer.image_stabilizer_id = t.image_stabilizer_id WHERE image_stabilizer.component_id = ? AND image_stabilizer.timestamp = (SELECT MAX(timestamp) FROM image_stabilizer WHERE image_stabilizer.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($image_stabilizer_id = null, $component_id = null, $component_id_int = null, $image_stabilizer_type_id = null, $image_stabilizer_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($image_stabilizer_id !== null)
		{
			self::$image_stabilizer_id = $image_stabilizer_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES image_stabilizer WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO image_stabilizer (image_stabilizer_id, component_id, component_id_int, image_stabilizer_type_id, image_stabilizer_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE image_stabilizer_id=VALUES(image_stabilizer_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),image_stabilizer_type_id=VALUES(image_stabilizer_type_id),image_stabilizer_type_id_int=VALUES(image_stabilizer_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->image_stabilizer_id, $this->component_id, $this->component_id_int, $this->image_stabilizer_type_id, $this->image_stabilizer_type_id_int, $this->timestamp, $this->youser_id);
