<?php
class battery_display_runtime
{

	protected static $instance = null;
	private static $table = 'battery_display_runtime';
	public static $data = array();
	public $battery_display_runtime_id;
	public $component_id;
	public $component_id_int;
	public $battery_display_runtime_type_id;
	public $battery_display_runtime_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($battery_display_runtime_id = null)
	{
		if($battery_display_runtime_id != null)
		{
			self::$battery_display_runtime_id = $battery_display_runtime_id;
		}
	...
	{
		$description['battery_display_runtime_type_id'] = 'battery_display_runtime_type_id';
		$description['battery_display_runtime_type_id_int'] = 'battery_display_runtime_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM battery_display_runtime  LEFT JOIN battery_display_runtime_type ON battery_display_runtime.battery_display_runtime_type_id = battery_display_runtime_type.battery_display_runtime_type_id  LEFT JOIN battery_display_runtime AS t ON battery_display_runtime.battery_display_runtime_id = t.battery_display_runtime_id WHERE battery_display_runtime.component_id = ? ORDER BY battery_display_runtime.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['battery_display_runtime_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['battery_display_runtime_type_id'] = 'multiple';
		$description['battery_display_runtime_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM battery_display_runtime  LEFT JOIN battery_display_runtime_type ON battery_display_runtime.battery_display_runtime_type_id = battery_display_runtime_type.battery_display_runtime_type_id  LEFT JOIN battery_display_runtime AS t ON battery_display_runtime.battery_display_runtime_id = t.battery_display_runtime_id WHERE battery_display_runtime.component_id = ? AND battery_display_runtime.timestamp = (SELECT MAX(timestamp) FROM battery_display_runtime WHERE battery_display_runtime.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($battery_display_runtime_id = null, $component_id = null, $component_id_int = null, $battery_display_runtime_type_id = null, $battery_display_runtime_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($battery_display_runtime_id !== null)
		{
			self::$battery_display_runtime_id = $battery_display_runtime_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES battery_display_runtime WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO battery_display_runtime (battery_display_runtime_id, component_id, component_id_int, battery_display_runtime_type_id, battery_display_runtime_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE battery_display_runtime_id=VALUES(battery_display_runtime_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),battery_display_runtime_type_id=VALUES(battery_display_runtime_type_id),battery_display_runtime_type_id_int=VALUES(battery_display_runtime_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->battery_display_runtime_id, $this->component_id, $this->component_id_int, $this->battery_display_runtime_type_id, $this->battery_display_runtime_type_id_int, $this->timestamp, $this->youser_id);
