<?php
class video_player_functions
{

	protected static $instance = null;
	private static $table = 'video_player_functions';
	public static $data = array();
	public $video_player_functions_id;
	public $component_id;
	public $component_id_int;
	public $video_player_functions_type_id;
	public $video_player_functions_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($video_player_functions_id = null)
	{
		if($video_player_functions_id != null)
		{
			self::$video_player_functions_id = $video_player_functions_id;
		}
	...
	{
		$description['video_player_functions_type_id'] = 'video_player_functions_type_id';
		$description['video_player_functions_type_id_int'] = 'video_player_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM video_player_functions  LEFT JOIN video_player_functions_type ON video_player_functions.video_player_functions_type_id = video_player_functions_type.video_player_functions_type_id  LEFT JOIN video_player_functions AS t ON video_player_functions.video_player_functions_id = t.video_player_functions_id WHERE video_player_functions.component_id = ? ORDER BY video_player_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['video_player_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['video_player_functions_type_id'] = 'multiple';
		$description['video_player_functions_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM video_player_functions  LEFT JOIN video_player_functions_type ON video_player_functions.video_player_functions_type_id = video_player_functions_type.video_player_functions_type_id  LEFT JOIN video_player_functions AS t ON video_player_functions.video_player_functions_id = t.video_player_functions_id WHERE video_player_functions.component_id = ? AND video_player_functions.timestamp = (SELECT MAX(timestamp) FROM video_player_functions WHERE video_player_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($video_player_functions_id = null, $component_id = null, $component_id_int = null, $video_player_functions_type_id = null, $video_player_functions_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($video_player_functions_id !== null)
		{
			self::$video_player_functions_id = $video_player_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES video_player_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO video_player_functions (video_player_functions_id, component_id, component_id_int, video_player_functions_type_id, video_player_functions_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE video_player_functions_id=VALUES(video_player_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),video_player_functions_type_id=VALUES(video_player_functions_type_id),video_player_functions_type_id_int=VALUES(video_player_functions_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->video_player_functions_id, $this->component_id, $this->component_id_int, $this->video_player_functions_type_id, $this->video_player_functions_type_id_int, $this->timestamp, $this->youser_id);
