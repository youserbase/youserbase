...
class body_specials
{
	...
	private static $table = 'body_specials';
	public static $data = array();
	public $body_specials_id;
	public $component_id;
	public $component_id_int;
	public $body_specials_type_id;
	public $body_specials_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($body_specials_id = null)
	{
		if($body_specials_id != null)
		{
			self::$body_specials_id = $body_specials_id;
		}
	...
	{
		$description['body_specials_type_id'] = 'body_specials_type_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM body_specials  LEFT JOIN body_specials_type ON body_specials.body_specials_type_id = body_specials_type.body_specials_type_id  LEFT JOIN body_specials AS t ON body_specials.body_specials_id = t.body_specials_id WHERE body_specials.component_id = ? ORDER BY body_specials.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['body_specials_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['body_specials_type_id'] = 'multiple';
		$description['body_specials_type_id_int'] = 'hidden';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM body_specials  LEFT JOIN body_specials_type ON body_specials.body_specials_type_id = body_specials_type.body_specials_type_id  LEFT JOIN body_specials AS t ON body_specials.body_specials_id = t.body_specials_id WHERE body_specials.component_id = ? AND body_specials.timestamp = (SELECT MAX(timestamp) FROM body_specials WHERE body_specials.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($body_specials_id = null, $component_id = null, $component_id_int = null, $body_specials_type_id = null, $body_specials_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($body_specials_id !== null)
		{
			self::$body_specials_id = $body_specials_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES body_specials WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO body_specials (body_specials_id, component_id, component_id_int, body_specials_type_id, body_specials_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE body_specials_id=VALUES(body_specials_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),body_specials_type_id=VALUES(body_specials_type_id),body_specials_type_id_int=VALUES(body_specials_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->body_specials_id, $this->component_id, $this->component_id_int, $this->body_specials_type_id, $this->body_specials_type_id_int, $this->timestamp, $this->youser_id);
