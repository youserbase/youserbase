<?php
class data_network_protocolls
{

	protected static $instance = null;
	private static $table = 'data_network_protocolls';
	public static $data = array();
	public $data_network_protocolls_id;
	public $component_id;
	public $component_id_int;
	public $data_network_protocolls_type_id;
	public $data_network_protocolls_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($data_network_protocolls_id = null)
	{
		if($data_network_protocolls_id != null)
		{
			self::$data_network_protocolls_id = $data_network_protocolls_id;
		}
	...
	{
		$description['data_network_protocolls_type_id'] = 'data_network_protocolls_type_id';
		$description['data_network_protocolls_type_id_int'] = 'data_network_protocolls_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM data_network_protocolls  LEFT JOIN data_network_protocolls_type ON data_network_protocolls.data_network_protocolls_type_id = data_network_protocolls_type.data_network_protocolls_type_id  LEFT JOIN data_network_protocolls AS t ON data_network_protocolls.data_network_protocolls_id = t.data_network_protocolls_id WHERE data_network_protocolls.component_id = ? ORDER BY data_network_protocolls.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['data_network_protocolls_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['data_network_protocolls_type_id'] = 'multiple';
		$description['data_network_protocolls_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM data_network_protocolls  LEFT JOIN data_network_protocolls_type ON data_network_protocolls.data_network_protocolls_type_id = data_network_protocolls_type.data_network_protocolls_type_id  LEFT JOIN data_network_protocolls AS t ON data_network_protocolls.data_network_protocolls_id = t.data_network_protocolls_id WHERE data_network_protocolls.component_id = ? AND data_network_protocolls.timestamp = (SELECT MAX(timestamp) FROM data_network_protocolls WHERE data_network_protocolls.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($data_network_protocolls_id = null, $component_id = null, $component_id_int = null, $data_network_protocolls_type_id = null, $data_network_protocolls_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($data_network_protocolls_id !== null)
		{
			self::$data_network_protocolls_id = $data_network_protocolls_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES data_network_protocolls WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO data_network_protocolls (data_network_protocolls_id, component_id, component_id_int, data_network_protocolls_type_id, data_network_protocolls_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE data_network_protocolls_id=VALUES(data_network_protocolls_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),data_network_protocolls_type_id=VALUES(data_network_protocolls_type_id),data_network_protocolls_type_id_int=VALUES(data_network_protocolls_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->data_network_protocolls_id, $this->component_id, $this->component_id_int, $this->data_network_protocolls_type_id, $this->data_network_protocolls_type_id_int, $this->timestamp, $this->youser_id);
