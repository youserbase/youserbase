...
class time_functions
{
	...
	private static $table = 'time_functions';
	public static $data = array();
	public $time_functions_id;
	public $component_id;
	public $component_id_int;
	public $time_functions_type_id;
	public $time_functions_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($time_functions_id = null)
	{
		if($time_functions_id != null)
		{
			self::$time_functions_id = $time_functions_id;
		}
	...
	{
		$description['time_functions_type_id'] = 'time_functions_type_id';
		$description['time_functions_type_id_int'] = 'time_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM time_functions  LEFT JOIN time_functions_type ON time_functions.time_functions_type_id = time_functions_type.time_functions_type_id  LEFT JOIN time_functions AS t ON time_functions.time_functions_id = t.time_functions_id WHERE time_functions.component_id = ? ORDER BY time_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['time_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['time_functions_type_id'] = 'multiple';
		$description['time_functions_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM time_functions  LEFT JOIN time_functions_type ON time_functions.time_functions_type_id = time_functions_type.time_functions_type_id  LEFT JOIN time_functions AS t ON time_functions.time_functions_id = t.time_functions_id WHERE time_functions.component_id = ? AND time_functions.timestamp = (SELECT MAX(timestamp) FROM time_functions WHERE time_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($time_functions_id = null, $component_id = null, $component_id_int = null, $time_functions_type_id = null, $time_functions_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($time_functions_id !== null)
		{
			self::$time_functions_id = $time_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES time_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO time_functions (time_functions_id, component_id, component_id_int, time_functions_type_id, time_functions_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE time_functions_id=VALUES(time_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),time_functions_type_id=VALUES(time_functions_type_id),time_functions_type_id_int=VALUES(time_functions_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->time_functions_id, $this->component_id, $this->component_id_int, $this->time_functions_type_id, $this->time_functions_type_id_int, $this->timestamp, $this->youser_id);
