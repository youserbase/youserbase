<?php
class picture_view_functions
{

	protected static $instance = null;
	private static $table = 'picture_view_functions';
	public static $data = array();
	public $picture_view_functions_id;
	public $component_id;
	public $component_id_int;
	public $picture_view_functions_type_id;
	public $picture_view_functions_type_id_int;
	public $youser_id;
	public $timestemp;
	...
	public function Get($picture_view_functions_id = null)
	{
		if($picture_view_functions_id != null)
		{
			self::$picture_view_functions_id = $picture_view_functions_id;
		}
	...
	{
		$description['picture_view_functions_type_id'] = 'picture_view_functions_type_id';
		$description['picture_view_functions_type_id_int'] = 'picture_view_functions_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM picture_view_functions  LEFT JOIN picture_view_functions_type ON picture_view_functions.picture_view_functions_type_id = picture_view_functions_type.picture_view_functions_type_id  LEFT JOIN picture_view_functions AS t ON picture_view_functions.picture_view_functions_id = t.picture_view_functions_id WHERE picture_view_functions.component_id = ? ORDER BY picture_view_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['picture_view_functions_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['picture_view_functions_type_id'] = 'multiple';
		$description['picture_view_functions_type_id_int'] = 'multiple';
		$description['youser_id'] = 'notshown';
		$description['timestemp'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM picture_view_functions  LEFT JOIN picture_view_functions_type ON picture_view_functions.picture_view_functions_type_id = picture_view_functions_type.picture_view_functions_type_id  LEFT JOIN picture_view_functions AS t ON picture_view_functions.picture_view_functions_id = t.picture_view_functions_id WHERE picture_view_functions.component_id = ? AND picture_view_functions.timestamp = (SELECT MAX(timestamp) FROM picture_view_functions WHERE picture_view_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($picture_view_functions_id = null, $component_id = null, $component_id_int = null, $picture_view_functions_type_id = null, $picture_view_functions_type_id_int = null, $youser_id = null, $timestemp = null)
	{
		if($picture_view_functions_id !== null)
		{
			self::$picture_view_functions_id = $picture_view_functions_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES picture_view_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO picture_view_functions (picture_view_functions_id, component_id, component_id_int, picture_view_functions_type_id, picture_view_functions_type_id_int, youser_id, timestemp) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE picture_view_functions_id=VALUES(picture_view_functions_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),picture_view_functions_type_id=VALUES(picture_view_functions_type_id),picture_view_functions_type_id_int=VALUES(picture_view_functions_type_id_int),youser_id=VALUES(youser_id),timestemp=VALUES(timestemp);", $this->picture_view_functions_id, $this->component_id, $this->component_id_int, $this->picture_view_functions_type_id, $this->picture_view_functions_type_id_int, $this->youser_id, $this->timestemp);
