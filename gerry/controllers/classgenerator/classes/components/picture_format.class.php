...
class picture_format
{
	...
	private static $table = 'picture_format';
	public static $data = array();
	public $picture_format_id;
	public $picture_format_id_int;
	public $component_id;
	public $component_id_int;
	public $picture_format_type_id;
	public $picture_format_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($picture_format_id = null)
	{
		if($picture_format_id != null)
		{
			self::$picture_format_id = $picture_format_id;
		}
	...
	{
		$description['picture_format_type_id'] = 'picture_format_type_id';
		$description['picture_format_type_id_int'] = 'picture_format_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM picture_format  LEFT JOIN picture_format_type ON picture_format.picture_format_type_id = picture_format_type.picture_format_type_id  LEFT JOIN picture_format AS t ON picture_format.picture_format_id = t.picture_format_id WHERE picture_format.component_id = ? ORDER BY picture_format.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['picture_format_id'] = 'hidden';
		$description['picture_format_id_int'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['picture_format_type_id'] = 'multiple';
		$description['picture_format_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM picture_format  LEFT JOIN picture_format_type ON picture_format.picture_format_type_id = picture_format_type.picture_format_type_id  LEFT JOIN picture_format AS t ON picture_format.picture_format_id = t.picture_format_id WHERE picture_format.component_id = ? AND picture_format.timestamp = (SELECT MAX(timestamp) FROM picture_format WHERE picture_format.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($picture_format_id = null, $picture_format_id_int = null, $component_id = null, $component_id_int = null, $picture_format_type_id = null, $picture_format_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($picture_format_id !== null)
		{
			self::$picture_format_id = $picture_format_id;
		}		if($picture_format_id_int !== null)
		{
			self::$picture_format_id_int = $picture_format_id_int;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES picture_format WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO picture_format (picture_format_id, picture_format_id_int, component_id, component_id_int, picture_format_type_id, picture_format_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE picture_format_id=VALUES(picture_format_id),picture_format_id_int=VALUES(picture_format_id_int),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),picture_format_type_id=VALUES(picture_format_type_id),picture_format_type_id_int=VALUES(picture_format_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->picture_format_id, $this->picture_format_id_int, $this->component_id, $this->component_id_int, $this->picture_format_type_id, $this->picture_format_type_id_int, $this->timestamp, $this->youser_id);
