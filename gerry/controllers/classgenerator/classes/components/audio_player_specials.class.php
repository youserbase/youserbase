<?php
class audio_player_specials
{

	protected static $instance = null;
	private static $table = 'audio_player_specials';
	public static $data = array();
	public $audio_player_specials_id;
	public $component_id;
	public $component_id_int;
	public $audio_player_specials_type_id;
	public $timestamp;
	public $youser_id;
	...
	public function Get($audio_player_specials_id = null)
	{
		if($audio_player_specials_id != null)
		{
			self::$audio_player_specials_id = $audio_player_specials_id;
		}
	...
	{
		$description['audio_player_specials_type_id'] = 'audio_player_specials_type_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM audio_player_specials  LEFT JOIN audio_player_specials_type ON audio_player_specials.audio_player_specials_type_id = audio_player_specials_type.audio_player_specials_type_id  LEFT JOIN audio_player_specials AS t ON audio_player_specials.audio_player_specials_id = t.audio_player_specials_id WHERE audio_player_specials.component_id = ? ORDER BY audio_player_specials.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['audio_player_specials_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['audio_player_specials_type_id'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM audio_player_specials  LEFT JOIN audio_player_specials_type ON audio_player_specials.audio_player_specials_type_id = audio_player_specials_type.audio_player_specials_type_id  LEFT JOIN audio_player_specials AS t ON audio_player_specials.audio_player_specials_id = t.audio_player_specials_id WHERE audio_player_specials.component_id = ? AND audio_player_specials.timestamp = (SELECT MAX(timestamp) FROM audio_player_specials WHERE audio_player_specials.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($audio_player_specials_id = null, $component_id = null, $component_id_int = null, $audio_player_specials_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($audio_player_specials_id !== null)
		{
			self::$audio_player_specials_id = $audio_player_specials_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES audio_player_specials WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO audio_player_specials (audio_player_specials_id, component_id, component_id_int, audio_player_specials_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE audio_player_specials_id=VALUES(audio_player_specials_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),audio_player_specials_type_id=VALUES(audio_player_specials_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->audio_player_specials_id, $this->component_id, $this->component_id_int, $this->audio_player_specials_type_id, $this->timestamp, $this->youser_id);
