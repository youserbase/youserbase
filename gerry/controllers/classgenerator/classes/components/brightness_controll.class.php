<?php
class brightness_controll
{

	protected static $instance = null;
	private static $table = 'brightness_controll';
	public static $data = array();
	public $brightness_controll_id;
	public $component_id;
	public $component_id_int;
	public $brightness_controll_type_id;
	public $brightness_controll_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($brightness_controll_id = null)
	{
		if($brightness_controll_id != null)
		{
			self::$brightness_controll_id = $brightness_controll_id;
		}
	...
	{
		$description['brightness_controll_type_id'] = 'brightness_controll_type_id';
		$description['brightness_controll_type_id_int'] = 'brightness_controll_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM brightness_controll  LEFT JOIN brightness_controll_type ON brightness_controll.brightness_controll_type_id = brightness_controll_type.brightness_controll_type_id  LEFT JOIN brightness_controll AS t ON brightness_controll.brightness_controll_id = t.brightness_controll_id WHERE brightness_controll.component_id = ? ORDER BY brightness_controll.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['brightness_controll_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['brightness_controll_type_id'] = 'multiple';
		$description['brightness_controll_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM brightness_controll  LEFT JOIN brightness_controll_type ON brightness_controll.brightness_controll_type_id = brightness_controll_type.brightness_controll_type_id  LEFT JOIN brightness_controll AS t ON brightness_controll.brightness_controll_id = t.brightness_controll_id WHERE brightness_controll.component_id = ? AND brightness_controll.timestamp = (SELECT MAX(timestamp) FROM brightness_controll WHERE brightness_controll.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($brightness_controll_id = null, $component_id = null, $component_id_int = null, $brightness_controll_type_id = null, $brightness_controll_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($brightness_controll_id !== null)
		{
			self::$brightness_controll_id = $brightness_controll_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES brightness_controll WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO brightness_controll (brightness_controll_id, component_id, component_id_int, brightness_controll_type_id, brightness_controll_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE brightness_controll_id=VALUES(brightness_controll_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),brightness_controll_type_id=VALUES(brightness_controll_type_id),brightness_controll_type_id_int=VALUES(brightness_controll_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->brightness_controll_id, $this->component_id, $this->component_id_int, $this->brightness_controll_type_id, $this->brightness_controll_type_id_int, $this->timestamp, $this->youser_id);
