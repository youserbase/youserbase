...
class call_notification
{
	...
	private static $table = 'call_notification';
	public static $data = array();
	public $call_notification_id;
	public $component_id;
	public $component_id_int;
	public $call_notification_number_of_ringtones;
	public $call_notification_type_id;
	public $call_notification_number_of_voices;
	public $timestamp;
	public $youser_id;
	...
	public function Get($call_notification_id = null)
	{
		if($call_notification_id != null)
		{
			self::$call_notification_id = $call_notification_id;
		}
	...
	{
		$description['call_notification_number_of_ringtones'] = 'call_notification_number_of_ringtones';
		$description['call_notification_type_id'] = 'call_notification_type_id';
		$description['call_notification_number_of_voices'] = 'call_notification_number_of_voices';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM call_notification  LEFT JOIN call_notification_type ON call_notification.call_notification_type_id = call_notification_type.call_notification_type_id  LEFT JOIN call_notification AS t ON call_notification.call_notification_id = t.call_notification_id WHERE call_notification.component_id = ? ORDER BY call_notification.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['call_notification_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['call_notification_number_of_ringtones'] = 'text';
		$description['call_notification_type_id'] = 'multiple';
		$description['call_notification_number_of_voices'] = 'text';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM call_notification  LEFT JOIN call_notification_type ON call_notification.call_notification_type_id = call_notification_type.call_notification_type_id  LEFT JOIN call_notification AS t ON call_notification.call_notification_id = t.call_notification_id WHERE call_notification.component_id = ? AND call_notification.timestamp = (SELECT MAX(timestamp) FROM call_notification WHERE call_notification.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($call_notification_id = null, $component_id = null, $component_id_int = null, $call_notification_number_of_ringtones = null, $call_notification_type_id = null, $call_notification_number_of_voices = null, $timestamp = null, $youser_id = null)
	{
		if($call_notification_id !== null)
		{
			self::$call_notification_id = $call_notification_id;
		...
		}		if($call_notification_number_of_ringtones !== null)
		{
			self::$call_notification_number_of_ringtones = $call_notification_number_of_ringtones;
		}		if($call_notification_type_id !== null)
		{
			self::$call_notification_type_id = $call_notification_type_id;
		}		if($call_notification_number_of_voices !== null)
		{
			self::$call_notification_number_of_voices = $call_notification_number_of_voices;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES call_notification WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO call_notification (call_notification_id, component_id, component_id_int, call_notification_number_of_ringtones, call_notification_type_id, call_notification_number_of_voices, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE call_notification_id=VALUES(call_notification_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),call_notification_number_of_ringtones=VALUES(call_notification_number_of_ringtones),call_notification_type_id=VALUES(call_notification_type_id),call_notification_number_of_voices=VALUES(call_notification_number_of_voices),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->call_notification_id, $this->component_id, $this->component_id_int, $this->call_notification_number_of_ringtones, $this->call_notification_type_id, $this->call_notification_number_of_voices, $this->timestamp, $this->youser_id);
