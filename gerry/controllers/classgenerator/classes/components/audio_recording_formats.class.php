<?php
class audio_recording_formats
{

	protected static $instance = null;
	private static $table = 'audio_recording_formats';
	public static $data = array();
	public $audio_recording_formats_id;
	public $component_id;
	public $component_id_int;
	public $music_format_type_id;
	public $music_format_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($audio_recording_formats_id = null)
	{
		if($audio_recording_formats_id != null)
		{
			self::$audio_recording_formats_id = $audio_recording_formats_id;
		}
	...
	{
		$description['music_format_type_id'] = 'music_format_type_id';
		$description['music_format_type_id_int'] = 'music_format_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM audio_recording_formats  LEFT JOIN music_format_type ON audio_recording_formats.music_format_type_id = music_format_type.music_format_type_id  LEFT JOIN audio_recording_formats AS t ON audio_recording_formats.audio_recording_formats_id = t.audio_recording_formats_id WHERE audio_recording_formats.component_id = ? ORDER BY audio_recording_formats.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['audio_recording_formats_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['music_format_type_id'] = 'multiple';
		$description['music_format_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM audio_recording_formats  LEFT JOIN music_format_type ON audio_recording_formats.music_format_type_id = music_format_type.music_format_type_id  LEFT JOIN audio_recording_formats AS t ON audio_recording_formats.audio_recording_formats_id = t.audio_recording_formats_id WHERE audio_recording_formats.component_id = ? AND audio_recording_formats.timestamp = (SELECT MAX(timestamp) FROM audio_recording_formats WHERE audio_recording_formats.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($audio_recording_formats_id = null, $component_id = null, $component_id_int = null, $music_format_type_id = null, $music_format_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($audio_recording_formats_id !== null)
		{
			self::$audio_recording_formats_id = $audio_recording_formats_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES audio_recording_formats WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO audio_recording_formats (audio_recording_formats_id, component_id, component_id_int, music_format_type_id, music_format_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE audio_recording_formats_id=VALUES(audio_recording_formats_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),music_format_type_id=VALUES(music_format_type_id),music_format_type_id_int=VALUES(music_format_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->audio_recording_formats_id, $this->component_id, $this->component_id_int, $this->music_format_type_id, $this->music_format_type_id_int, $this->timestamp, $this->youser_id);
