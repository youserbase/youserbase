<?php
class picture_editing
{

	protected static $instance = null;
	private static $table = 'picture_editing';
	public static $data = array();
	public $picture_editing_id;
	public $component_id;
	public $component_id_int;
	public $picture_editing_type_id;
	public $picture_editing_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($picture_editing_id = null)
	{
		if($picture_editing_id != null)
		{
			self::$picture_editing_id = $picture_editing_id;
		}
	...
	{
		$description['picture_editing_type_id'] = 'picture_editing_type_id';
		$description['picture_editing_type_id_int'] = 'picture_editing_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM picture_editing  LEFT JOIN picture_editing_type ON picture_editing.picture_editing_type_id = picture_editing_type.picture_editing_type_id  LEFT JOIN picture_editing AS t ON picture_editing.picture_editing_id = t.picture_editing_id WHERE picture_editing.component_id = ? ORDER BY picture_editing.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['picture_editing_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['picture_editing_type_id'] = 'multiple';
		$description['picture_editing_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM picture_editing  LEFT JOIN picture_editing_type ON picture_editing.picture_editing_type_id = picture_editing_type.picture_editing_type_id  LEFT JOIN picture_editing AS t ON picture_editing.picture_editing_id = t.picture_editing_id WHERE picture_editing.component_id = ? AND picture_editing.timestamp = (SELECT MAX(timestamp) FROM picture_editing WHERE picture_editing.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($picture_editing_id = null, $component_id = null, $component_id_int = null, $picture_editing_type_id = null, $picture_editing_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($picture_editing_id !== null)
		{
			self::$picture_editing_id = $picture_editing_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES picture_editing WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO picture_editing (picture_editing_id, component_id, component_id_int, picture_editing_type_id, picture_editing_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE picture_editing_id=VALUES(picture_editing_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),picture_editing_type_id=VALUES(picture_editing_type_id),picture_editing_type_id_int=VALUES(picture_editing_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->picture_editing_id, $this->component_id, $this->component_id_int, $this->picture_editing_type_id, $this->picture_editing_type_id_int, $this->timestamp, $this->youser_id);
