<?php
class tv_transmitter_standards
{

	protected static $instance = null;
	private static $table = 'tv_transmitter_standards';
	public static $data = array();
	public $tv_transmitter_standards_id;
	public $component_id;
	public $component_id_int;
	public $tv_transmitter_standards_type_id;
	public $tv_transmitter_standards_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($tv_transmitter_standards_id = null)
	{
		if($tv_transmitter_standards_id != null)
		{
			self::$tv_transmitter_standards_id = $tv_transmitter_standards_id;
		}
	...
	{
		$description['tv_transmitter_standards_type_id'] = 'tv_transmitter_standards_type_id';
		$description['tv_transmitter_standards_type_id_int'] = 'tv_transmitter_standards_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM tv_transmitter_standards  LEFT JOIN tv_transmitter_standards_type ON tv_transmitter_standards.tv_transmitter_standards_type_id = tv_transmitter_standards_type.tv_transmitter_standards_type_id  LEFT JOIN tv_transmitter_standards AS t ON tv_transmitter_standards.tv_transmitter_standards_id = t.tv_transmitter_standards_id WHERE tv_transmitter_standards.component_id = ? ORDER BY tv_transmitter_standards.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['tv_transmitter_standards_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['tv_transmitter_standards_type_id'] = 'multiple';
		$description['tv_transmitter_standards_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM tv_transmitter_standards  LEFT JOIN tv_transmitter_standards_type ON tv_transmitter_standards.tv_transmitter_standards_type_id = tv_transmitter_standards_type.tv_transmitter_standards_type_id  LEFT JOIN tv_transmitter_standards AS t ON tv_transmitter_standards.tv_transmitter_standards_id = t.tv_transmitter_standards_id WHERE tv_transmitter_standards.component_id = ? AND tv_transmitter_standards.timestamp = (SELECT MAX(timestamp) FROM tv_transmitter_standards WHERE tv_transmitter_standards.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($tv_transmitter_standards_id = null, $component_id = null, $component_id_int = null, $tv_transmitter_standards_type_id = null, $tv_transmitter_standards_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($tv_transmitter_standards_id !== null)
		{
			self::$tv_transmitter_standards_id = $tv_transmitter_standards_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES tv_transmitter_standards WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO tv_transmitter_standards (tv_transmitter_standards_id, component_id, component_id_int, tv_transmitter_standards_type_id, tv_transmitter_standards_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE tv_transmitter_standards_id=VALUES(tv_transmitter_standards_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),tv_transmitter_standards_type_id=VALUES(tv_transmitter_standards_type_id),tv_transmitter_standards_type_id_int=VALUES(tv_transmitter_standards_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->tv_transmitter_standards_id, $this->component_id, $this->component_id_int, $this->tv_transmitter_standards_type_id, $this->tv_transmitter_standards_type_id_int, $this->timestamp, $this->youser_id);
