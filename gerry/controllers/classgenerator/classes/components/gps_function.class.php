...
class gps_function
{
	...
	private static $table = 'gps_function';
	public static $data = array();
	public $gps_function_id;
	public $component_id;
	public $component_id_int;
	public $gps_function_type_id;
	public $gps_function_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($gps_function_id = null)
	{
		if($gps_function_id != null)
		{
			self::$gps_function_id = $gps_function_id;
		}
	...
	{
		$description['gps_function_type_id'] = 'gps_function_type_id';
		$description['gps_function_type_id_int'] = 'gps_function_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM gps_function  LEFT JOIN gps_function_type ON gps_function.gps_function_type_id = gps_function_type.gps_function_type_id  LEFT JOIN gps_function AS t ON gps_function.gps_function_id = t.gps_function_id WHERE gps_function.component_id = ? ORDER BY gps_function.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['gps_function_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['gps_function_type_id'] = 'multiple';
		$description['gps_function_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM gps_function  LEFT JOIN gps_function_type ON gps_function.gps_function_type_id = gps_function_type.gps_function_type_id  LEFT JOIN gps_function AS t ON gps_function.gps_function_id = t.gps_function_id WHERE gps_function.component_id = ? AND gps_function.timestamp = (SELECT MAX(timestamp) FROM gps_function WHERE gps_function.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($gps_function_id = null, $component_id = null, $component_id_int = null, $gps_function_type_id = null, $gps_function_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($gps_function_id !== null)
		{
			self::$gps_function_id = $gps_function_id;
		...
		}		if($gps_function_type_id !== null)
		{
			self::$gps_function_type_id = $gps_function_type_id;
		}		if($gps_function_type_id_int !== null)
		{
			self::$gps_function_type_id_int = $gps_function_type_id_int;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES gps_function WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO gps_function (gps_function_id, component_id, component_id_int, gps_function_type_id, gps_function_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE gps_function_id=VALUES(gps_function_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),gps_function_type_id=VALUES(gps_function_type_id),gps_function_type_id_int=VALUES(gps_function_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->gps_function_id, $this->component_id, $this->component_id_int, $this->gps_function_type_id, $this->gps_function_type_id_int, $this->timestamp, $this->youser_id);
