...
class screensaver
{
	...
	private static $table = 'screensaver';
	public static $data = array();
	public $screensaver_id;
	public $component_id;
	public $component_id_int;
	public $screensaver_type_id;
	public $screensaver_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($screensaver_id = null)
	{
		if($screensaver_id != null)
		{
	...
	{
		$description['screensaver_type_id'] = 'screensaver_type_id';
		$description['screensaver_type_id_int'] = 'screensaver_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM screensaver  LEFT JOIN screensaver_type ON screensaver.screensaver_type_id = screensaver_type.screensaver_type_id  LEFT JOIN screensaver AS t ON screensaver.screensaver_id = t.screensaver_id WHERE screensaver.component_id = ? ORDER BY screensaver.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['screensaver_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['screensaver_type_id'] = 'multiple';
		$description['screensaver_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM screensaver  LEFT JOIN screensaver_type ON screensaver.screensaver_type_id = screensaver_type.screensaver_type_id  LEFT JOIN screensaver AS t ON screensaver.screensaver_id = t.screensaver_id WHERE screensaver.component_id = ? AND screensaver.timestamp = (SELECT MAX(timestamp) FROM screensaver WHERE screensaver.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($screensaver_id = null, $component_id = null, $component_id_int = null, $screensaver_type_id = null, $screensaver_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($screensaver_id !== null)
		{
			self::$screensaver_id = $screensaver_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES screensaver WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO screensaver (screensaver_id, component_id, component_id_int, screensaver_type_id, screensaver_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE screensaver_id=VALUES(screensaver_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),screensaver_type_id=VALUES(screensaver_type_id),screensaver_type_id_int=VALUES(screensaver_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->screensaver_id, $this->component_id, $this->component_id_int, $this->screensaver_type_id, $this->screensaver_type_id_int, $this->timestamp, $this->youser_id);
