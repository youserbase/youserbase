<?php
class caller_protocoll
{

	protected static $instance = null;
	private static $table = 'caller_protocoll';
	public static $data = array();
	public $caller_protocoll_id;
	public $component_id;
	public $component_id_int;
	public $caller_protocoll_type_id;
	public $caller_protocoll_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($caller_protocoll_id = null)
	{
		if($caller_protocoll_id != null)
		{
			self::$caller_protocoll_id = $caller_protocoll_id;
		}
	...
	{
		$description['caller_protocoll_type_id'] = 'caller_protocoll_type_id';
		$description['caller_protocoll_type_id_int'] = 'caller_protocoll_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM caller_protocoll  LEFT JOIN caller_protocoll_type ON caller_protocoll.caller_protocoll_type_id = caller_protocoll_type.caller_protocoll_type_id  LEFT JOIN caller_protocoll AS t ON caller_protocoll.caller_protocoll_id = t.caller_protocoll_id WHERE caller_protocoll.component_id = ? ORDER BY caller_protocoll.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['caller_protocoll_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['caller_protocoll_type_id'] = 'multiple';
		$description['caller_protocoll_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM caller_protocoll  LEFT JOIN caller_protocoll_type ON caller_protocoll.caller_protocoll_type_id = caller_protocoll_type.caller_protocoll_type_id  LEFT JOIN caller_protocoll AS t ON caller_protocoll.caller_protocoll_id = t.caller_protocoll_id WHERE caller_protocoll.component_id = ? AND caller_protocoll.timestamp = (SELECT MAX(timestamp) FROM caller_protocoll WHERE caller_protocoll.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($caller_protocoll_id = null, $component_id = null, $component_id_int = null, $caller_protocoll_type_id = null, $caller_protocoll_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($caller_protocoll_id !== null)
		{
			self::$caller_protocoll_id = $caller_protocoll_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES caller_protocoll WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO caller_protocoll (caller_protocoll_id, component_id, component_id_int, caller_protocoll_type_id, caller_protocoll_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE caller_protocoll_id=VALUES(caller_protocoll_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),caller_protocoll_type_id=VALUES(caller_protocoll_type_id),caller_protocoll_type_id_int=VALUES(caller_protocoll_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->caller_protocoll_id, $this->component_id, $this->component_id_int, $this->caller_protocoll_type_id, $this->caller_protocoll_type_id_int, $this->timestamp, $this->youser_id);
