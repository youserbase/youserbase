...
class mail_texts
{
	...
	private static $table = 'mail_texts';
	public static $data = array();
	public $mail_texts_id;
	public $language_id;
	public $mail_type;
	public $mail;
	public $youser_id;
	...
	public function Get($mail_texts_id = null)
	{
		if($mail_texts_id != null)
		{
			self::$mail_texts_id = $mail_texts_id;
		}
	...
	{
		$description['mail_texts_id'] = 'mail_texts_id';
		$description['language_id'] = 'language_id';
		$description['mail_type'] = 'mail_type';
		$description['mail'] = 'mail';
		$description['youser_id'] = 'youser_id';
		$description['timestamp'] = 'timestamp';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM mail_texts  WHERE mail_texts.component_id = ? ORDER BY mail_texts.timestamp DESC;", $component_id)->to_array();
	...
	public function Loadedit($component_id = null)
	{
		...
		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM mail_texts  WHERE mail_texts.component_id = ? ORDER BY mail_texts.timestamp DESC LIMIT 0,1;", $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($mail_texts_id = null, $language_id = null, $mail_type = null, $mail = null, $youser_id = null, $timestamp = null)
	{
		if($mail_texts_id !== null)
		{
			self::$mail_texts_id = $mail_texts_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES mail_texts WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO mail_texts (mail_texts_id, language_id, mail_type, mail, youser_id, timestamp) VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE mail_texts_id=VALUES(mail_texts_id),language_id=VALUES(language_id),mail_type=VALUES(mail_type),mail=VALUES(mail),youser_id=VALUES(youser_id),timestamp=VALUES(timestamp);", $this->mail_texts_id, $this->language_id, $this->mail_type, $this->mail, $this->youser_id, $this->timestamp);
