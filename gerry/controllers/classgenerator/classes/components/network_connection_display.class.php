<?php
class network_connection_display
{

	protected static $instance = null;
	private static $table = 'network_connection_display';
	public static $data = array();
	public $network_connection_display_id;
	public $component_id;
	public $component_id_int;
	public $network_connection_display_type_id;
	public $network_connection_display_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($network_connection_display_id = null)
	{
		if($network_connection_display_id != null)
		{
			self::$network_connection_display_id = $network_connection_display_id;
		}
	...
	{
		$description['network_connection_display_type_id'] = 'network_connection_display_type_id';
		$description['network_connection_display_type_id_int'] = 'network_connection_display_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM network_connection_display  LEFT JOIN network_connection_display_type ON network_connection_display.network_connection_display_type_id = network_connection_display_type.network_connection_display_type_id  LEFT JOIN network_connection_display AS t ON network_connection_display.network_connection_display_id = t.network_connection_display_id WHERE network_connection_display.component_id = ? ORDER BY network_connection_display.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['network_connection_display_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['network_connection_display_type_id'] = 'multiple';
		$description['network_connection_display_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM network_connection_display  LEFT JOIN network_connection_display_type ON network_connection_display.network_connection_display_type_id = network_connection_display_type.network_connection_display_type_id  LEFT JOIN network_connection_display AS t ON network_connection_display.network_connection_display_id = t.network_connection_display_id WHERE network_connection_display.component_id = ? AND network_connection_display.timestamp = (SELECT MAX(timestamp) FROM network_connection_display WHERE network_connection_display.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($network_connection_display_id = null, $component_id = null, $component_id_int = null, $network_connection_display_type_id = null, $network_connection_display_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($network_connection_display_id !== null)
		{
			self::$network_connection_display_id = $network_connection_display_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES network_connection_display WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO network_connection_display (network_connection_display_id, component_id, component_id_int, network_connection_display_type_id, network_connection_display_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE network_connection_display_id=VALUES(network_connection_display_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),network_connection_display_type_id=VALUES(network_connection_display_type_id),network_connection_display_type_id_int=VALUES(network_connection_display_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->network_connection_display_id, $this->component_id, $this->component_id_int, $this->network_connection_display_type_id, $this->network_connection_display_type_id_int, $this->timestamp, $this->youser_id);
