<?php
class mobilephone_profiles
{

	protected static $instance = null;
	private static $table = 'mobilephone_profiles';
	public static $data = array();
	public $mobilephone_profiles_id;
	public $component_id;
	public $component_id_int;
	public $mobilephone_profiles_type_id;
	public $mobilephone_profiles_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($mobilephone_profiles_id = null)
	{
		if($mobilephone_profiles_id != null)
		{
			self::$mobilephone_profiles_id = $mobilephone_profiles_id;
		}
	...
	{
		$description['mobilephone_profiles_type_id'] = 'mobilephone_profiles_type_id';
		$description['mobilephone_profiles_type_id_int'] = 'mobilephone_profiles_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM mobilephone_profiles  LEFT JOIN mobilephone_profiles_type ON mobilephone_profiles.mobilephone_profiles_type_id = mobilephone_profiles_type.mobilephone_profiles_type_id  LEFT JOIN mobilephone_profiles AS t ON mobilephone_profiles.mobilephone_profiles_id = t.mobilephone_profiles_id WHERE mobilephone_profiles.component_id = ? ORDER BY mobilephone_profiles.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['mobilephone_profiles_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['mobilephone_profiles_type_id'] = 'multiple';
		$description['mobilephone_profiles_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM mobilephone_profiles  LEFT JOIN mobilephone_profiles_type ON mobilephone_profiles.mobilephone_profiles_type_id = mobilephone_profiles_type.mobilephone_profiles_type_id  LEFT JOIN mobilephone_profiles AS t ON mobilephone_profiles.mobilephone_profiles_id = t.mobilephone_profiles_id WHERE mobilephone_profiles.component_id = ? AND mobilephone_profiles.timestamp = (SELECT MAX(timestamp) FROM mobilephone_profiles WHERE mobilephone_profiles.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($mobilephone_profiles_id = null, $component_id = null, $component_id_int = null, $mobilephone_profiles_type_id = null, $mobilephone_profiles_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($mobilephone_profiles_id !== null)
		{
			self::$mobilephone_profiles_id = $mobilephone_profiles_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES mobilephone_profiles WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO mobilephone_profiles (mobilephone_profiles_id, component_id, component_id_int, mobilephone_profiles_type_id, mobilephone_profiles_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE mobilephone_profiles_id=VALUES(mobilephone_profiles_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),mobilephone_profiles_type_id=VALUES(mobilephone_profiles_type_id),mobilephone_profiles_type_id_int=VALUES(mobilephone_profiles_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->mobilephone_profiles_id, $this->component_id, $this->component_id_int, $this->mobilephone_profiles_type_id, $this->mobilephone_profiles_type_id_int, $this->timestamp, $this->youser_id);
