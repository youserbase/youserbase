...
class security_features
{
	...
	private static $table = 'security_features';
	public static $data = array();
	public $security_features_id;
	public $component_id;
	public $component_id_int;
	public $security_features_type_id;
	public $security_features_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($security_features_id = null)
	{
		if($security_features_id != null)
		{
			self::$security_features_id = $security_features_id;
		}
	...
	{
		$description['security_features_type_id'] = 'security_features_type_id';
		$description['security_features_type_id_int'] = 'security_features_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM security_features  LEFT JOIN security_features_type ON security_features.security_features_type_id = security_features_type.security_features_type_id  LEFT JOIN security_features AS t ON security_features.security_features_id = t.security_features_id WHERE security_features.component_id = ? ORDER BY security_features.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['security_features_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['security_features_type_id'] = 'multiple';
		$description['security_features_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM security_features  LEFT JOIN security_features_type ON security_features.security_features_type_id = security_features_type.security_features_type_id  LEFT JOIN security_features AS t ON security_features.security_features_id = t.security_features_id WHERE security_features.component_id = ? AND security_features.timestamp = (SELECT MAX(timestamp) FROM security_features WHERE security_features.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($security_features_id = null, $component_id = null, $component_id_int = null, $security_features_type_id = null, $security_features_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($security_features_id !== null)
		{
			self::$security_features_id = $security_features_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES security_features WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO security_features (security_features_id, component_id, component_id_int, security_features_type_id, security_features_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE security_features_id=VALUES(security_features_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),security_features_type_id=VALUES(security_features_type_id),security_features_type_id_int=VALUES(security_features_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->security_features_id, $this->component_id, $this->component_id_int, $this->security_features_type_id, $this->security_features_type_id_int, $this->timestamp, $this->youser_id);
