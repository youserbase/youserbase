<?php
class audio_player_functions
{

	protected static $instance = null;
	private static $table = 'audio_player_functions';
	public static $data = array();
	public $audio_player_functions_id;
	public $audio_player_functions_id_int;
	public $component_id;
	public $component_id_int;
	public $audio_player_functions_type_id;
	public $timestamp;
	public $youser_id;
	...
	public function Get($audio_player_functions_id = null)
	{
		if($audio_player_functions_id != null)
		{
			self::$audio_player_functions_id = $audio_player_functions_id;
		}
	...
	{
		$description['audio_player_functions_type_id'] = 'audio_player_functions_type_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM audio_player_functions  LEFT JOIN audio_player_functions_type ON audio_player_functions.audio_player_functions_type_id = audio_player_functions_type.audio_player_functions_type_id  LEFT JOIN audio_player_functions AS t ON audio_player_functions.audio_player_functions_id = t.audio_player_functions_id WHERE audio_player_functions.component_id = ? ORDER BY audio_player_functions.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['audio_player_functions_id'] = 'hidden';
		$description['audio_player_functions_id_int'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['audio_player_functions_type_id'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM audio_player_functions  LEFT JOIN audio_player_functions_type ON audio_player_functions.audio_player_functions_type_id = audio_player_functions_type.audio_player_functions_type_id  LEFT JOIN audio_player_functions AS t ON audio_player_functions.audio_player_functions_id = t.audio_player_functions_id WHERE audio_player_functions.component_id = ? AND audio_player_functions.timestamp = (SELECT MAX(timestamp) FROM audio_player_functions WHERE audio_player_functions.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($audio_player_functions_id = null, $audio_player_functions_id_int = null, $component_id = null, $component_id_int = null, $audio_player_functions_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($audio_player_functions_id !== null)
		{
			self::$audio_player_functions_id = $audio_player_functions_id;
		}		if($audio_player_functions_id_int !== null)
		{
			self::$audio_player_functions_id_int = $audio_player_functions_id_int;
		...
		}		if($audio_player_functions_type_id !== null)
		{
			self::$audio_player_functions_type_id = $audio_player_functions_type_id;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES audio_player_functions WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO audio_player_functions (audio_player_functions_id, audio_player_functions_id_int, component_id, component_id_int, audio_player_functions_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE audio_player_functions_id=VALUES(audio_player_functions_id),audio_player_functions_id_int=VALUES(audio_player_functions_id_int),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),audio_player_functions_type_id=VALUES(audio_player_functions_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->audio_player_functions_id, $this->audio_player_functions_id_int, $this->component_id, $this->component_id_int, $this->audio_player_functions_type_id, $this->timestamp, $this->youser_id);
