...
class sync_software
{
	...
	private static $table = 'sync_software';
	public static $data = array();
	public $sync_software_id;
	public $component_id;
	public $component_id_int;
	public $sync_software_type_id;
	public $sync_software_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($sync_software_id = null)
	{
		if($sync_software_id != null)
		{
			self::$sync_software_id = $sync_software_id;
		}
	...
	{
		$description['sync_software_type_id'] = 'sync_software_type_id';
		$description['sync_software_type_id_int'] = 'sync_software_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM sync_software  LEFT JOIN sync_software_type ON sync_software.sync_software_type_id = sync_software_type.sync_software_type_id  LEFT JOIN sync_software AS t ON sync_software.sync_software_id = t.sync_software_id WHERE sync_software.component_id = ? ORDER BY sync_software.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['sync_software_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['sync_software_type_id'] = 'multiple';
		$description['sync_software_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM sync_software  LEFT JOIN sync_software_type ON sync_software.sync_software_type_id = sync_software_type.sync_software_type_id  LEFT JOIN sync_software AS t ON sync_software.sync_software_id = t.sync_software_id WHERE sync_software.component_id = ? AND sync_software.timestamp = (SELECT MAX(timestamp) FROM sync_software WHERE sync_software.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($sync_software_id = null, $component_id = null, $component_id_int = null, $sync_software_type_id = null, $sync_software_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($sync_software_id !== null)
		{
			self::$sync_software_id = $sync_software_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES sync_software WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO sync_software (sync_software_id, component_id, component_id_int, sync_software_type_id, sync_software_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE sync_software_id=VALUES(sync_software_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),sync_software_type_id=VALUES(sync_software_type_id),sync_software_type_id_int=VALUES(sync_software_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->sync_software_id, $this->component_id, $this->component_id_int, $this->sync_software_type_id, $this->sync_software_type_id_int, $this->timestamp, $this->youser_id);
