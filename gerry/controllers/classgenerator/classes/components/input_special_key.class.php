<?php
class input_special_key
{

	protected static $instance = null;
	private static $table = 'input_special_key';
	public static $data = array();
	public $input_special_key_id;
	public $component_id;
	public $component_id_int;
	public $input_special_key_type_id;
	public $input_special_key_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($input_special_key_id = null)
	{
		if($input_special_key_id != null)
		{
			self::$input_special_key_id = $input_special_key_id;
		}
	...
	{
		$description['input_special_key_type_id'] = 'input_special_key_type_id';
		$description['input_special_key_type_id_int'] = 'input_special_key_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM input_special_key  LEFT JOIN input_special_key_type ON input_special_key.input_special_key_type_id = input_special_key_type.input_special_key_type_id  LEFT JOIN input_special_key AS t ON input_special_key.input_special_key_id = t.input_special_key_id WHERE input_special_key.component_id = ? ORDER BY input_special_key.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['input_special_key_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['input_special_key_type_id'] = 'multiple';
		$description['input_special_key_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM input_special_key  LEFT JOIN input_special_key_type ON input_special_key.input_special_key_type_id = input_special_key_type.input_special_key_type_id  LEFT JOIN input_special_key AS t ON input_special_key.input_special_key_id = t.input_special_key_id WHERE input_special_key.component_id = ? AND input_special_key.timestamp = (SELECT MAX(timestamp) FROM input_special_key WHERE input_special_key.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($input_special_key_id = null, $component_id = null, $component_id_int = null, $input_special_key_type_id = null, $input_special_key_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($input_special_key_id !== null)
		{
			self::$input_special_key_id = $input_special_key_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES input_special_key WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO input_special_key (input_special_key_id, component_id, component_id_int, input_special_key_type_id, input_special_key_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE input_special_key_id=VALUES(input_special_key_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),input_special_key_type_id=VALUES(input_special_key_type_id),input_special_key_type_id_int=VALUES(input_special_key_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->input_special_key_id, $this->component_id, $this->component_id_int, $this->input_special_key_type_id, $this->input_special_key_type_id_int, $this->timestamp, $this->youser_id);
