...
class gps_software
{
	...
	private static $table = 'gps_software';
	public static $data = array();
	public $gps_software_id;
	public $component_id;
	public $component_id_int;
	public $gps_software_type_id;
	public $timestamp;
	public $youser_id;
	...
	public function Get($gps_software_id = null)
	{
		if($gps_software_id != null)
		{
			self::$gps_software_id = $gps_software_id;
		}
	...
	{
		$description['gps_software_type_id'] = 'gps_software_type_id';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM gps_software  LEFT JOIN gps_software_type ON gps_software.gps_software_type_id = gps_software_type.gps_software_type_id  LEFT JOIN gps_software AS t ON gps_software.gps_software_id = t.gps_software_id WHERE gps_software.component_id = ? ORDER BY gps_software.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['gps_software_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['gps_software_type_id'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM gps_software  LEFT JOIN gps_software_type ON gps_software.gps_software_type_id = gps_software_type.gps_software_type_id  LEFT JOIN gps_software AS t ON gps_software.gps_software_id = t.gps_software_id WHERE gps_software.component_id = ? AND gps_software.timestamp = (SELECT MAX(timestamp) FROM gps_software WHERE gps_software.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($gps_software_id = null, $component_id = null, $component_id_int = null, $gps_software_type_id = null, $timestamp = null, $youser_id = null)
	{
		if($gps_software_id !== null)
		{
			self::$gps_software_id = $gps_software_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES gps_software WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO gps_software (gps_software_id, component_id, component_id_int, gps_software_type_id, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE gps_software_id=VALUES(gps_software_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),gps_software_type_id=VALUES(gps_software_type_id),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->gps_software_id, $this->component_id, $this->component_id_int, $this->gps_software_type_id, $this->timestamp, $this->youser_id);
