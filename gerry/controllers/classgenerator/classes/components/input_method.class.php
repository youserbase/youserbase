...
class input_method
{
	...
	private static $table = 'input_method';
	public static $data = array();
	public $input_method_id;
	public $component_id;
	public $component_id_int;
	public $input_method_type_id;
	public $input_method_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($input_method_id = null)
	{
		if($input_method_id != null)
		{
	...
	{
		$description['input_method_type_id'] = 'input_method_type_id';
		$description['input_method_type_id_int'] = 'input_method_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM input_method  LEFT JOIN input_method_type ON input_method.input_method_type_id = input_method_type.input_method_type_id  LEFT JOIN input_method AS t ON input_method.input_method_id = t.input_method_id WHERE input_method.component_id = ? ORDER BY input_method.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['input_method_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['input_method_type_id'] = 'multiple';
		$description['input_method_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM input_method  LEFT JOIN input_method_type ON input_method.input_method_type_id = input_method_type.input_method_type_id  LEFT JOIN input_method AS t ON input_method.input_method_id = t.input_method_id WHERE input_method.component_id = ? AND input_method.timestamp = (SELECT MAX(timestamp) FROM input_method WHERE input_method.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($input_method_id = null, $component_id = null, $component_id_int = null, $input_method_type_id = null, $input_method_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($input_method_id !== null)
		{
			self::$input_method_id = $input_method_id;
		...
		}		if($input_method_type_id_int !== null)
		{
			self::$input_method_type_id_int = $input_method_type_id_int;
		}		if($timestamp !== null)
		{
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES input_method WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO input_method (input_method_id, component_id, component_id_int, input_method_type_id, input_method_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE input_method_id=VALUES(input_method_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),input_method_type_id=VALUES(input_method_type_id),input_method_type_id_int=VALUES(input_method_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->input_method_id, $this->component_id, $this->component_id_int, $this->input_method_type_id, $this->input_method_type_id_int, $this->timestamp, $this->youser_id);
