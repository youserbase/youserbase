<?php
class additional_hardware
{

	protected static $instance = null;
	private static $table = 'additional_hardware';
	public static $data = array();
	public $additional_hardware_id;
	public $component_id;
	public $component_id_int;
	public $additional_hardware_type_id;
	public $additional_hardware_type_id_int;
	public $timestamp;
	public $youser_id;
	...
	public function Get($additional_hardware_id = null)
	{
		if($additional_hardware_id != null)
		{
			self::$additional_hardware_id = $additional_hardware_id;
		}
	...
	{
		$description['additional_hardware_type_id'] = 'additional_hardware_type_id';
		$description['additional_hardware_type_id_int'] = 'additional_hardware_type_id_int';
		if($component_id == null) return $description;

		$response = DBManager::Get('devices')->query("SELECT * FROM additional_hardware  LEFT JOIN additional_hardware_type ON additional_hardware.additional_hardware_type_id = additional_hardware_type.additional_hardware_type_id  LEFT JOIN additional_hardware AS t ON additional_hardware.additional_hardware_id = t.additional_hardware_id WHERE additional_hardware.component_id = ? ORDER BY additional_hardware.timestamp DESC;", $component_id)->to_array();
	...
	{
		$description['additional_hardware_id'] = 'hidden';
		$description['component_id'] = 'hidden';
		$description['component_id_int'] = 'hidden';
		$description['additional_hardware_type_id'] = 'multiple';
		$description['additional_hardware_type_id_int'] = 'multiple';
		$description['timestamp'] = 'notshown';
		$description['youser_id'] = 'notshown';

		$data = $description;
		$result = DBManager::Get('devices')->query("SELECT * FROM additional_hardware  LEFT JOIN additional_hardware_type ON additional_hardware.additional_hardware_type_id = additional_hardware_type.additional_hardware_type_id  LEFT JOIN additional_hardware AS t ON additional_hardware.additional_hardware_id = t.additional_hardware_id WHERE additional_hardware.component_id = ? AND additional_hardware.timestamp = (SELECT MAX(timestamp) FROM additional_hardware WHERE additional_hardware.component_id = ?);", $component_id, $component_id)->to_array();
		if($result !== null){
			$data = array();
	...
	public function Set($additional_hardware_id = null, $component_id = null, $component_id_int = null, $additional_hardware_type_id = null, $additional_hardware_type_id_int = null, $timestamp = null, $youser_id = null)
	{
		if($additional_hardware_id !== null)
		{
			self::$additional_hardware_id = $additional_hardware_id;
	...
	{
		DBManager::Get('devices')->query("LOCK TABLES additional_hardware WRITE;");
		$db = DBManager::Get('devices')->query("INSERT INTO additional_hardware (additional_hardware_id, component_id, component_id_int, additional_hardware_type_id, additional_hardware_type_id_int, timestamp, youser_id) VALUES(?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE additional_hardware_id=VALUES(additional_hardware_id),component_id=VALUES(component_id),component_id_int=VALUES(component_id_int),additional_hardware_type_id=VALUES(additional_hardware_type_id),additional_hardware_type_id_int=VALUES(additional_hardware_type_id_int),timestamp=VALUES(timestamp),youser_id=VALUES(youser_id);", $this->additional_hardware_id, $this->component_id, $this->component_id_int, $this->additional_hardware_type_id, $this->additional_hardware_type_id_int, $this->timestamp, $this->youser_id);
